...
public class Reachability<K> implements TGraphAlgorithm<K, Tuple2<Long, Long>, Integer, Long,
    ...
    public static final class FinalVerticesMapper<K> implements MapFunction<Vertex<K, Tuple3<Long, Long, Long>>, Boolean> {
        @Override
